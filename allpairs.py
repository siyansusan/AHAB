...
class AllPairsAnalysis(Ahab):
    ...
    def prepareOutputFiles(self,DIR):
        ### Add in a for loop to create files for all pairs of guides,
        ### put in a dictionary
    ...
    def process2HSPsSameStrand(self,anno):
        ...
        ### Need to generalize: for both ends of the deletion interval,
        ### call a function that finds the nearest guide target site and
        ### make sure it's within 30 bp (or whatever)
